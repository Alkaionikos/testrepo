...
# Callback to enable/disable the year dropdown based on the selected statistics
@app.callback(
...
# Callback to update the output container based on the selected statistics and year
@app.callback(
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        R_chart4 = dcc.Graph(
            figure=px.bar(unemployment_effect, x='Vehicle_Type', y='Automobile_Sales',
